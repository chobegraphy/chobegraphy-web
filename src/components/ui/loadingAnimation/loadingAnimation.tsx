...
const LoadingAnimation = () => {
  ...
  return (
    <div className="fixed example top-0 bottom-0 left-0 right-0 bg-dark-primary-color dark:bg-light-primary-color w-full flex items-center justify-center z-30 h-full text-5xl">
