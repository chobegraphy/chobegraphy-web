    ...
    return (
        ...
        >
            ...
            >
                ...
                />
                <div className="rounded-2xl h-full bg-gradient-to-t from-black/60 via-black/0 to-black/0  absolute w-full  bottom-0 p-2 flex items-center justify-between text-sm text-white"></div>
            </Link>
            <SiAdobelightroom style={{ color: imgData?.colors[1]?.hex }} className="absolute top-3 right-3" />
            {/* Overlay for Icons */}
            {loadedImg && (
