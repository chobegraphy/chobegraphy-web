...
const CopyRightType = ({ SelectedCopyrightType, setSelectedCopyrightType, colors }: any) => {
    ...
    return (
        <div>
            ...
            {/* copy right cc-0 */}
            <section>
                <div className={`w-full flex justify-between items-center ${showCopyRightInfo1 ? "pb-1 pt-2.5" : "py-2.5"}`}> <div onClick={() => setSelectedCopyrightType("CC-0")} className="flex justify-between items-center px-2 cursor-pointer  w-[80px]">
                ...
                <h1 className={`${showCopyRightInfo1 ? "h-full opacity-100 pb-2.5" : "h-0 opacity-0 -z-40"} transform duration-300 px-2 font-Space text-justify`}> <span className="font-BanglaSubHeading">
                ...
                <div className={`${!showCopyRightInfo1 ? "hidden" : ""} my-0 h-[1.5px] w-full bg-light-secondary-color  rounded-full opacity-50 `} /></section>
            ...
            <section>
                ...
                <h1 className={`${showCopyRightInfo2 ? "h-full opacity-100 pb-2.5" : "h-0 opacity-0 -z-40"} transform duration-300 px-2 font-Space text-justify`}> <span className="font-BanglaSubHeading">
